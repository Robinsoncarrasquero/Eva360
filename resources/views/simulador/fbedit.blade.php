...
<div class="container">
    ...
    <div class="row">
        ...
        <form   action="{{route('simulador.feedback.update',$evaluado->id)  }}" method="post" name="frmfb">
            @csrf
            ...
            <div class="row mt-4">
                <div class="col">
                    ...
                    <a href="{{route('simulador.historicoevaluaciones')}}" class="btn btn-dark float-left">Regresar</a>
