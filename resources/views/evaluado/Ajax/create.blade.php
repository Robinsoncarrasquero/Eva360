		...
		<div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title">Nuevo evaluado</h3>
				</div>
				<div class="panel-body">
					<div class="table-container">
						<form method="POST" action="{{ route('evaluado.store') }}"  role="form">
							{{ csrf_field() }}
							<div class="row">
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
										<input type="text" name="name" id="name" class="form-control input-sm" placeholder="Nombre del evaluado">
									</div>
								</div>
								<div class="col-xs-6 col-sm-6 col-md-6">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-xs-12 col-sm-12 col-md-12">
									...
									<a href="{{ route('evaluado.index') }}" class="btn btn-info btn-block" >Atrás</a>
								</div>
