...
<div class="container">
        ...
        <div class="card-header">
            ...
            <form action="{{ route('plantillas.procesar')  }}" method="POST">
                @csrf
                {{-- @method('PATCH') --}}
                <div class="col-lg-12">
                    <label for="pathFile">Archivo de la importacion</label>
                    <input id="pathFile" class="form-control" type="text" name="pathFile" readonly value="{{$pathFile}}">
                </div>
                <div class="col-lg-12">
                    <label for="name">Nombre de la importacion</label>
                    <input id="name" class="form-control" type="text" name="name" readonly value="{{$carga_masiva_name}}">
                </div>

                <div class="col-lg-12">
                    <label for="description">Descripcion</label>
                    <textarea placeholder="Descripcion" type="text" id="description" class="form-control" rows="4"
                        maxlength="250" name="description">{{$carga_masiva_name}}</textarea>
                </div>
