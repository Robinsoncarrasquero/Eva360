...
@section('title',"Evaluadores por Objetivo")
...
<div class="container">
    ...
    <div class="card card-header mt-2 mb-4">
        <div class="text text-center">
            <h5>Evaluacion por objetivos de <span class="text-danger">{{ $evaluado->name }}</span></h5>
        </div>
    </div>
        ...
        <div class="table table-responsive col-sm-12 col-md-6 mt-1">
            <table id="table{{ $evaluador->id }}" class="table table-striped table-table">
                ...
                <tr id="{{ $evaluador->id }}">
                    ...
                    {{-- <th>
                    <span><a class="btn btn-success btn-sm" href="{{ route('objetivo.metas',$evaluador) }}">Ver</a></span>
                    </th> --}}
                </tr>
    ...
    <div class="clearfix">
        @if (!Auth::user()->admin() && !Auth::user()->is_manager)
