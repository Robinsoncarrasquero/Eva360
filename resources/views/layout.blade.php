  ...
  <body>
    ...
    <header>
      ...
      <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
        <a class="navbar-brand" href="{{ route('lanzar.index') }}#">Eva360</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('evaluado.index') }}">Crear Evaluado</a>
            </li>
            <li class="nav-item">
    ...
    <footer class="footer">
      <div class="container">
        <span class="text-muted">Sistema de Valoracion de Competencias basados en los métodos 90 180 360</span>
      </div>
    </footer>
