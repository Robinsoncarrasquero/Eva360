...
@section('title',"Creacion de status de Feedback")
...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="mt-1 text-center">
            <h5>Nuevo status de Feedback</h5>
        </div>

        <form action="{{ route('fbstatu.store') }}" method="POST">
            @csrf
            <div class="row">
            ...
            <div class="clearfix">
                <a href="{{route('fbstatu.index')}}" class="btn btn-dark float-left">Back</a>
